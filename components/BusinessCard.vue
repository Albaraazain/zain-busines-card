      ...
      <div class="card card-front">
        ...
        <div class="content">
          <div class="company-name">
            <h1 class="arabic">شركة سنابل الأندلس</h1>
            <h2 class="english">Sanabel Al-Andalus</h2>
          </div>
          <div class="contact-person">
            <p class="arabic">د. طاهر محمد زين - المدير الفني</p>
            <p class="english">Dr. Taher Mohamed Zein - Technical Director</p>
          </div>
          ...
          <div class="address">
            <p class="arabic">السعودية. جدة, حي الروابي - الكيلو 10</p>
            <p class="english">Saudi Arabia, Jeddah, Al-Rawabi District, Kilometer 10</p>
          </div>
        </div>
      </div>
    </div>
...
<style scoped>
@import url('https://fonts.googleapis.com/css2?family=Amiri:wght@400;700&family=Roboto:wght@300;400&display=swap');
...
.contact-person, .contact-details, .address {
  font-size: 12px;
  line-height: 1.4;
  text-align: center;
}
